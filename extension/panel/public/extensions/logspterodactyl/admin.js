/*!
 * LogsPterodactyl - integracion con el menu del area de administracion
 *
 * Anade la entrada "LogsPterodactyl" al menu lateral sin tocar
...
(function () {
    ...
    var LABEL = 'LogsPterodactyl';
    var URL = '/admin/logspterodactyl';
