...
return new class () extends Migration {
    public function up(): void
    {
        if (!Schema::hasTable('logspterodactyl_settings')) {
            Schema::create('logspterodactyl_settings', function (Blueprint $table) {
        ...
        if (!Schema::hasTable('logspterodactyl_events')) {
            Schema::create('logspterodactyl_events', function (Blueprint $table) {
        ...
        if (!Schema::hasTable('logspterodactyl_install_events')) {
            Schema::create('logspterodactyl_install_events', function (Blueprint $table) {
                $table->bigIncrements('id');
                $table->unsignedInteger('server_id')->nullable();
        ...
        if (!Schema::hasTable('logspterodactyl_mail_logs')) {
            Schema::create('logspterodactyl_mail_logs', function (Blueprint $table) {
                $table->bigIncrements('id');
        ...
        if (!Schema::hasTable('logspterodactyl_resource_samples')) {
            Schema::create('logspterodactyl_resource_samples', function (Blueprint $table) {
                $table->bigIncrements('id');
        ...
        if (!Schema::hasTable('logspterodactyl_update_runs')) {
            Schema::create('logspterodactyl_update_runs', function (Blueprint $table) {
                $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('logspterodactyl_update_runs');
        Schema::dropIfExists('logspterodactyl_resource_samples');
        Schema::dropIfExists('logspterodactyl_mail_logs');
        Schema::dropIfExists('logspterodactyl_install_events');
        Schema::dropIfExists('logspterodactyl_events');
        Schema::dropIfExists('logspterodactyl_settings');
    }
};
