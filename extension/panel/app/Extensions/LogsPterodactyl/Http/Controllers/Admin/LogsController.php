...
class LogsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('logspterodactyl::admin.logs', [
            'files' => $files,
            'selected' => $selected,
    ...
    public function clear(Request $request)
    {
        ...
        if ($path === null) {
            return back()->with('logspterodactyl_error', 'Ese archivo de log no existe.');
        }
        ...
        return back()->with(
            $ok ? 'logspterodactyl_success' : 'logspterodactyl_error',
            $ok
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect()
            ->route('admin.logspterodactyl.logs')
            ->with(
                $ok ? 'logspterodactyl_success' : 'logspterodactyl_error',
