...
@section('logspterodactyl-title', 'Resumen')
@section('logspterodactyl-heading', 'LogsPterodactyl')
@section('logspterodactyl-subheading', 'estado del panel de un vistazo')
        ...
        <div class="col-md-7">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-condensed logspterodactyl-table">
                        <tbody>
                            <tr>
                    ...
                    <a href="{{ route('admin.logspterodactyl.installs') }}" class="btn btn-sm btn-primary">
                        @logsicon('arrow-right', 14) Ver instalaciones
                    </a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <a href="{{ route('admin.logspterodactyl.updater') }}" class="btn btn-sm btn-primary">
                        @logsicon('arrow-right', 14) Ir al actualizador
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="box">
                ...
                <div class="box-body no-padding">
                    @if($recent->isEmpty())
                        <p class="logspterodactyl-empty">Todavia no hay nada registrado.</p>
                    @else
                        <ul class="logspterodactyl-feed">
                            @foreach($recent as $event)
                                <li class="logspterodactyl-feed-item logspterodactyl-level-{{ $event->level }}">
                                    <span class="logspterodactyl-feed-dot"></span>
                                    <div>
                                        <div class="logspterodactyl-feed-message">{{ $event->message }}</div>
                                        <div class="logspterodactyl-feed-meta">
                ...
                <div class="box-footer">
                    <a href="{{ route('admin.logspterodactyl.events') }}" class="btn btn-sm btn-default">
                        @logsicon('file-text', 14) Ver el registro completo
                    </a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="logspterodactyl-levelbar">
                        @foreach(['emergency' => 'Emergencia', 'critical' => 'Critico', 'error' => 'Error', 'warning' => 'Aviso'] as $key => $label)
                            <div class="logspterodactyl-levelbar-item logspterodactyl-level-{{ $key }}">
                                <span class="logspterodactyl-levelbar-value">{{ $logs['counts'][$key] ?? 0 }}</span>
                                <span class="logspterodactyl-levelbar-label">{{ $label }}</span>
                            </div>
                        @endforeach
                    </div>

                    <a href="{{ route('admin.logspterodactyl.logs') }}" class="btn btn-sm btn-primary" style="margin-top:12px;">
                        @logsicon('arrow-right', 14) Abrir el visor
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <p class="text-muted" style="font-size:12px;">
                LogsPterodactyl v{{ $version }} &middot; compatible con el tema Arix: no reemplaza archivos del panel
