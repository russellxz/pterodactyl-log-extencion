...
use Pterodactyl\Extensions\ArixLog\Http\Controllers\Admin;

/*
|--------------------------------------------------------------------------
| Rutas del area de administracion de ArixLog
|--------------------------------------------------------------------------
|
| Se cargan desde el proveedor de la extension con el prefijo /admin/arixlog.
