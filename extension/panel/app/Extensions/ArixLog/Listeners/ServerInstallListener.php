 ...
 * el. El comando arixlog:watch-installs vuelve a cuadrar el historial cada
...
class ServerInstallListener
{
    ...
    public function handle(object $event): void
    {
        try {
            ...
            try {
                logger()->debug('[ArixLog] no se pudo cerrar el historial de instalacion: ' . $e->getMessage());
            } catch (\Throwable) {
                // Nada mas que hacer.
            }
        }
